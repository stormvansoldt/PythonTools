...
def exploit():
	...
	it is also possible on firmware v1.03 with valid authentication. It has been
	fixed on v1.04 and higher.
	'''
	...
	#opener = urllib.request.build_opener(urllib.request.ProxyHandler({'http': '127.0.0.1:8080'}))
